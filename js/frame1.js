(function () {
    ...
    const content = {
        ...
        nations: [
            ...
            { name: 'Fire',  desc: 'Driven & intense',    color: "#A35232", details: "The Fire Nation army is the main antagonist of the story. Fire is the element of power, and people of the Fire Nation are proud, ambitious and unflinching. Firebending is the only element where the bender creates their own element from internal heat and breath. They have an intense and aggressive attacking style, and their magic comes from the dragons." },
